...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="A script to extract CbC data from PDFs.")
    parser.add_argument("-f", "--force-rewrite", action="store_true", help="clears output directory before extracting, thus forcing a rewrite of all files.")
    parser.add_argument("-q", "--quiet", action="store_true", help="do not prompt the user whenever column or jurisdiction names are not standard. Non-standard names will have a trailing '_tocheck' flag.")
    parser.add_argument("-i", "--input_pdf_dir",default=os.path.join("inputs","pdf_repository"), help="the directory where the PDFs to be extracted can be found.")
    parser.add_argument("-o", "--write_tables_to_dir", default=os.path.join("outputs","individual_reports"), help="the directory at which the final CSVs for each report will be written.")
    parser.add_argument("-r", "--rules", default=os.path.join("inputs","rules.json"), help="the path of the rules file.")
    parser.add_argument("-m", "--metadata", default=os.path.join("inputs","metadata.json"), help="the path of the metadata file.")
    parser.add_argument("--intermediate_files_dir", default=os.path.join("intermediate_files"), help="the path of the metadata file.")
    parser.add_argument("-j", "--write_justifications_to", default=None, help="the path at which to write the file with the justifications for the rules.")
    parser.add_argument("--after_intervention_dir", default=os.path.join("inputs","files_after_human_intervention"), help="the path of the directory with manually edited input CSVs.")
